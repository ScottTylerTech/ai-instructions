...
## Agent Personality
<!-- Optional. Uncomment and fill in to give the model a team-specific persona or tone.
     Claude models respond especially well to this section.

- Tone: [e.g. direct, concise, collaborative]
- Voice: [e.g. senior engineer peer, not a tutor]
- Preferred style: [e.g. skip pleasantries, lead with the answer]
- Avoid: [e.g. excessive caveats, marketing language, emojis]
-->
