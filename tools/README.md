...
- Review this command sequence for safety and reproducibility.
- Convert this manual process into a safe repeatable script.
- Aggressively review my current branch diff against main and tell me if this PR is safe to open.
