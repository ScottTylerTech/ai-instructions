...
- For tables without a core schema break, you will generally only use `StandardPointInTime`
...
**Location:** `budget-dev-env-compose/scripts/DetermineTableRestoreSequence.sql`
